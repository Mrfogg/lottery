...
// source: lottery/game_info.proto
...
type GameInfo struct {
	...
	MValue  string `protobuf:"bytes,2,opt,name=mValue,proto3" json:"mValue,omitempty"`
	CValue  string `protobuf:"bytes,3,opt,name=cValue,proto3" json:"cValue,omitempty"`
	IdValue uint64 `protobuf:"varint,4,opt,name=idValue,proto3" json:"idValue,omitempty"`
}
...
func (*GameInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_757ec5ab45e8dd5b, []int{0}
}
...
func (m *GameInfo) GetIndex() string {
	if m != nil {
		return m.Index
	}
	return ""
...
func (m *GameInfo) GetMValue() string {
	if m != nil {
		return m.MValue
	}
	return ""
...
func (m *GameInfo) GetCValue() string {
	if m != nil {
		return m.CValue
	}
	return ""
...
func (m *GameInfo) GetIdValue() uint64 {
	if m != nil {
		return m.IdValue
	}
	return 0
...
func init() {
	proto.RegisterType((*GameInfo)(nil), "mrfogg.lottery.lottery.GameInfo")
}

func init() { proto.RegisterFile("lottery/game_info.proto", fileDescriptor_757ec5ab45e8dd5b) }

var fileDescriptor_757ec5ab45e8dd5b = []byte{
	// 192 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *GameInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.IdValue != 0 {
		i = encodeVarintGameInfo(dAtA, i, uint64(m.IdValue))
		i--
		dAtA[i] = 0x20
	}
	if len(m.CValue) > 0 {
		...
		i = encodeVarintGameInfo(dAtA, i, uint64(len(m.CValue)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.MValue) > 0 {
		i -= len(m.MValue)
		copy(dAtA[i:], m.MValue)
		i = encodeVarintGameInfo(dAtA, i, uint64(len(m.MValue)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Index) > 0 {
		i -= len(m.Index)
		copy(dAtA[i:], m.Index)
		i = encodeVarintGameInfo(dAtA, i, uint64(len(m.Index)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *GameInfo) Size() (n int) {
	...
	if m.IdValue != 0 {
		n += 1 + sovGameInfo(uint64(m.IdValue))
	}
	return n
}
...
func (m *GameInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MValue", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MValue = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
