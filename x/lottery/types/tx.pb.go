...
type MsgBidResponse struct {
	IsWin string `protobuf:"bytes,1,opt,name=isWin,proto3" json:"isWin,omitempty"`
}
...
func (m *MsgBidResponse) GetIsWin() string {
	if m != nil {
		return m.IsWin
	}
	return ""
...
func init() {
	proto.RegisterType((*MsgBid)(nil), "mrfogg.lottery.lottery.MsgBid")
	proto.RegisterType((*MsgBidResponse)(nil), "mrfogg.lottery.lottery.MsgBidResponse")
}
...
var fileDescriptor_16a4f365e1c6455d = []byte{
	...
	,
	...
	0x97, 0x9c, 0x9f, 0xab, 0xef, 0x0b, 0x36, 0x4b, 0x1f, 0x16, 0x4a, 0x15, 0x70, 0x56, 0x49, 0x65,
	0x41, 0x6a, 0x71, 0x12, 0x1b, 0x38, 0xcc, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x59, 0x88,
	0x69, 0xc2, 0x47, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) Bid(ctx context.Context, in *MsgBid, opts ...grpc.CallOption) (*MsgBidResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mrfogg.lottery.lottery.Msg/Bid", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Bid_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mrfogg.lottery.lottery.Msg/Bid",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mrfogg.lottery.lottery.Msg",
...
func (m *MsgBidResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.IsWin) > 0 {
		i -= len(m.IsWin)
		copy(dAtA[i:], m.IsWin)
		i = encodeVarintTx(dAtA, i, uint64(len(m.IsWin)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *MsgBidResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.IsWin = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])
