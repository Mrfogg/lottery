...
import (
	...
	"github.com/Mrfogg/lottery/testutil/sample"
	lotterysimulation "github.com/Mrfogg/lottery/x/lottery/simulation"
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgBid,
		lotterysimulation.SimulateMsgBid(am.accountKeeper, am.bankKeeper, am.keeper),
	))
