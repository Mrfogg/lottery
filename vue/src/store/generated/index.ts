...
import MrfoggLotteryMrfoggLotteryLottery from './Mrfogg/lottery/mrfogg.lottery.lottery'
...
export default { 
  MrfoggLotteryMrfoggLotteryLottery: load(MrfoggLotteryMrfoggLotteryLottery, 'mrfogg.lottery.lottery'),
