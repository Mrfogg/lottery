...
export const GenesisState = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.gameInfoList.push(GameInfo.decode(reader, reader.uint32()));
          break;
        default:
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (object.gameInfoList !== undefined && object.gameInfoList !== null) {
      for (const e of object.gameInfoList) {
        message.gameInfoList.push(GameInfo.fromJSON(e));
      }
    }
    return message;
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.gameInfoList) {
      obj.gameInfoList = message.gameInfoList.map((e) =>
  ...
  fromPartial(object: DeepPartial<GenesisState>): GenesisState {
    ...
    if (object.gameInfoList !== undefined && object.gameInfoList !== null) {
      for (const e of object.gameInfoList) {
        message.gameInfoList.push(GameInfo.fromPartial(e));
      }
    }
    return message;
  },
